      ...
      <nav class="navbar navbar-expand-lg">
        ...
        <div class="container">
          ...
          <div id="navbarcollapse" class="collapse navbar-collapse">
            ...
            <ul class="langs navbar-text"><a href="login" class="active">Login</a><span>           </span><a href="register">Sign Up</a></ul>
          </div>
        </div>
      </nav>
    </header>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="post.html"><img src="{{ asset('frontend/img/blog-post-1.jpeg') }}" alt="..." class="img-fluid"></a></div>
              ...
              <!-- post             -->
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="post.html"><img src="{{ asset('frontend/img/blog-post-2.jpg') }}" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">20 May | 2016</div>
                    <div class="category"><a href="#">Business</a></div>
              ...
              <!-- post             -->
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="post.html"><img src="{{ asset('frontend/img/blog-post-3.jpeg') }}" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">20 May | 2016</div>
                    <div class="category"><a href="#">Business</a></div>
              ...
              <!-- post -->
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="post.html"><img src="{{ asset('frontend/img/blog-post-4.jpeg') }}" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
                    <div class="date meta-last">20 May | 2016</div>
                    <div class="category"><a href="#">Business</a></div>
